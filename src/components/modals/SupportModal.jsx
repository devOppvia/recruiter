                ...
                >
                    ...
                    <div className="px-10 pt-10 pb-6 flex justify-between items-center bg-brand-primary/2">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-brand-primary tracking-tighter uppercase">Open <span className="text-brand-primary/40">Ticket</span></h2>
                                <p className="text-[10px] font-black text-brand-primary/30 uppercase tracking-widest">We're here to help you</p>
                            </div>
                        </div>
                        <button
                            onClick={() => dispatch(toggleSupportModal())}
                    ...
                    <form onSubmit={handleSubmit} className="p-10 space-y-6">
                        ...
                        <div className="p-4 bg-brand-primary/5 rounded-2xl flex items-start gap-3 border border-brand-primary/5">
                            <AlertCircle size={18} className="text-brand-primary/40 shrink-0 mt-0.5" />
                            <p className="text-[11px] font-bold text-brand-primary/60 leading-relaxed italic">
                                Our support team typically responds within 4-6 business hours. High priority tickets are reviewed faster.
                            </p>
                        </div>
                    </form>
                    ...
                    <div className="px-10 py-8 bg-brand-primary/2 border-t border-brand-primary/5 flex justify-end gap-3">
                        ...
                        >
                            <span className="font-black uppercase tracking-widest text-[10px]">Submit Request</span>
