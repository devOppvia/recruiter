    ...
    <div className="min-h-screen bg-[#F9FAFB] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="p-10 lg:p-16 text-center">
          ...
          <div className="space-y-6 mb-12">
            ...
            <p className="text-sm font-bold text-brand-primary/40 leading-relaxed max-w-md mx-auto">
              Our executive council is currently certifying your credentials.
              This strictly confidential process ensures the integrity of the
              Oppvia ecosystem.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 text-left">
            ...
            >
              ...
              <CheckCircle2
                ...
                strokeWidth={3}
              />
              <h3 className="font-black text-brand-primary text-xs uppercase tracking-widest mb-2">
                Protocol: Intake
              </h3>
              <p className="text-[11px] font-bold text-brand-primary/40 leading-relaxed">
                Identity and company dossiers have been successfully vaulted.
              </p>
            </motion.div>
            ...
            >
              <ArrowRight
                ...
                strokeWidth={3}
              />
              <h3 className="font-black text-brand-primary/20 text-xs uppercase tracking-widest mb-2">
                Protocol: Activation
              </h3>
              <p className="text-[11px] font-bold text-brand-primary/20 leading-relaxed">
                Your professional dashboard will be initialized automatically.
              </p>
            </motion.div>
          </div>
          ...
          <div className="space-y-8">
            <div className="inline-block px-6 py-3 bg-brand-primary/2 border border-brand-primary/5 rounded-2xl">
              <p className="text-[10px] font-black text-brand-primary/40 uppercase tracking-[0.2em]">
                Verification Window:{" "}
                <span className="text-brand-primary">24-48 Business Hours</span>
              </p>
            </div>
        ...
        <div className="px-10 py-8 bg-[#F9FAFB]/50 border-t border-brand-primary/5 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <span className="text-[10px] font-black text-brand-primary/20 uppercase tracking-[0.3em]">
            Oppvia ecosystem v4.0
          </span>
        </div>
      </motion.div>
    </div>
