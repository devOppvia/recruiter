...
const useReactApexChart = () => {
  ...
  let userOverviewDonutChartSeries = [500, 500, 500, 500]; 

  let userOverviewDonutChartOptions = {
    colors: ["#CCDCDD", "#64C1C3", "#2B5F60", "#001A1B"], // 4 colors
    labels: ["Approved", "Paused", "Completed", "Rejected"], // 4 labels
    legend: {
      show: false,
    },
    chart: {
  ...
  let columnChartSeriesOne = [
    {
      name: "Daily Sales",
      data: [1200, 1500, 1800, 1000, 2200, 2000, 2500],
      // 7 values = Mon to Sun
    },
  ];

  let columnChartOptionsOne = {
    colors: ["#2B5F60"], // Bar color
    chart: {
      type: "bar",
      height: 264,
      toolbar: {
    ...
    xaxis: {
      ...
      labels: {
        style: {
          colors: "#828898", // Font color for X axis
        },
      },
    },
    yaxis: {
      labels: {
        style: {
          colors: "#828898", // Font color for Y axis
        },
        formatter: function (value) {
          return (value / 1000).toFixed(0) + "k";
        },
